...
export default function FoodIntakeForm({
  ...
  const [state, formAction] = useActionState(createFoodIntakeLog, {
    status: "idle",
  });
  ...
  return (
    <>
      {showErrorDialog && (
        <AlertDialog open onOpenChange={setShowErrorDialog}>
          <AlertDialogContent>
            <AlertDialogTitle>Form Submission Failed</AlertDialogTitle>
            <AlertDialogDescription>
              {state?.message || "Please complete the required fields"}
            </AlertDialogDescription>
            <AlertDialogFooter>
              <Button
      ...
      {showSuccessDialog && (
        <AlertDialog open onOpenChange={setShowSuccessDialog}>
          <AlertDialogContent>
                      ...
                      <div>
                        ...
                        >
                          <SelectTrigger
                            className={cn(
                              "w-full",
                              form.formState.errors.mood && "border-red-500"
                            )}
                          >
                      ...
                      <div>
                        ...
                        >
                          <SelectTrigger
                            className={cn(
                              "w-full",
                              form.formState.errors.activity && "border-red-500"
                            )}
                          >
                            <SelectValue placeholder="Select..." />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        >
                          <SelectTrigger
                            className={cn(
                              "w-full",
                              form.formState.errors.water && "border-red-500"
                            )}
                          >
                            <SelectValue placeholder="Select..." />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        >
                          <SelectTrigger
                            className={cn(
                              "w-full",
                              form.formState.errors.sleep && "border-red-500"
                            )}
                          >
                            <SelectValue placeholder="Select..." />
                          </SelectTrigger>
